...
\definition{Multi-hop routing: multi-hop routing is ...}
...
%\begin{figure} 
%\centering
%\includegraphics[width=\textwidth]{cpuChart2.png}
%\caption{Figure shows average CPU percentage with different accumulation intervals (500 milliseconds).}
%\label{fig:cpuChart}
%\end{figure}
...
%Flat/stabilt når node venter på å same data igjen.. da venter også de andre nodene.. vil bare øke etter X accumualtions.. 
