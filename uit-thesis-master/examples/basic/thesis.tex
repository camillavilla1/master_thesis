...
The experiments are ran with a \textbf{1/5/10} second's measurement interval and system execute around X minutes. The experiments are done executing 50 and 100 nodes with a broadcast range at 50, as shown in Table \ref{tab:simTable}. 

Communication between nodes, gossiping \gls{ch} election and storing and accumulating data..
