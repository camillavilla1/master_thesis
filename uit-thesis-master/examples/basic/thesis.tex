...
To avoid having a \gls{ch} election occur simultaneously as a data accumulation, are these functionalities implemented to execute in  rounds. 

First elect leader, then after a while gather data 'X' times before electing a new leader and so on...

approach and improvements are discussed in Section \ref{disc:simult_el_acc}.
...
\section{Simultaneously CH Election And Data Accumulation} \label{disc:simult_el_acc}
