...
A leader accumulates data after a given interval and the experience are ran on 4 different accumulation intervals as listed below:
...
We also measure how many times nodes have been \gls{ch} at each time interval.
