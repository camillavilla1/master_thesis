...
In contrast, in our approach will a \gls{ch} be elected by the nodes in the cluster and not in a \gls{bs}. The \gls{ch} election will not consider "variables" such as battery level or number of nodes in the cluster.
...
A diversity to our approach is that ZebraNet stores multiple copies of the same data across multiple nodes while our apporach forwards the data to a ndoe
