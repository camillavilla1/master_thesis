...
\newacronym{camilla}{Camilla}{Camilla Stormoen}
...
\textit{FRA PAPER LEACH: Microsensor networks can contain hundreds or thousands of sensing nodes. It is desirable to make these nodes as cheap and energy-efficient as possible and rely on their large number tp obtain high quality results.}
