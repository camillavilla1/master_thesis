...
The proposed prototype of the system proved capable of ...
As a prototype, it still has room for improvements such as the availability of nodes in the system, \gls{ch}-elections and multiple \glspl{ch} in each cluster.

There is a need for conducting further work for a real-life environment in the Arctic Tundra...
...
\begin{figure*}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{1Mem_stdev.png}
            \caption[Network2]%
            {{\small Network 1}}    
            \label{fig:sendfig1}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.475\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{2Mem_stdev.png}
            \caption[]%
            {{\small Network 2}}    
            \label{fig:sendfig2}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{3Mem_stdev.png}
            \caption[]%
            {{\small Network 3}}    
            \label{fig:sendfig3}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{4Mem_stdev.png}
            \caption[]%
            {{\small Network 4}}    
            \label{fig:sendfig4}
        \end{subfigure}
...
\begin{figure*}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{1numSends.png}
            \caption[Network2]%
            {{\small Network 1}}    
            \label{fig:sendfig1}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.475\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{22numSends.png}
            \caption[]%
            {{\small Network 2}}    
            \label{fig:sendfig2}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{3numSends.png}
            \caption[]%
            {{\small Network 3}}    
            \label{fig:sendfig3}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{4numSends.png}
            \caption[]%
            {{\small Network 4}}    
            \label{fig:sendfig4}
        \end{subfigure}
...
Counting the number of \gls{ch} after a random number of accumulations, show a more increasing graph during execution because of the accumulations happens at different time interval causing the \gls{ch}-election to be more spread during execution. We can also see that this graph decrease right after 1500 iterations. The reason for this is assumable because nodes starts dying of energy consumption because of a more spread \gls{ch}-election and data accumulation during execution causing the nodes do drain more of their limited battery.
