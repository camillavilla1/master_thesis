...
The main functionality can be divided into X sub-sections: x,x,x,x.. The architecture of the system is presented in Figure X.. 
...
\subsection{Node Lookup Service}
...
\end{figure}
\fi
%\subsection{Data Transmission Forward Request}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{nearest_neighbor_grid.png}
\caption{Figure show grid..}
\label{fig:near_neighbor_grid}
\end{figure}
\fi
